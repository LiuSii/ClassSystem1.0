...
Recordset1_cmd.CommandText = "SELECT * FROM dbo.Logo WHERE (Ltimeo <> ? or Ldateo <> ?)" 
...
<body>
 <h3 style="color:white" align="center">可借会议室</h3>
...
%>
  <tr>
    <td style="color:white" width="200"><%=(Recordset1.Fields.Item("Lroomo").Value)%></td>
  </tr>
  <% 
...
%>
    ...
    <form action="Tbooked.asp" method="post" id="su">

...
<%
Dim teacherlogin
Dim teacherlogin_cmd
Dim teacherlogin_numRows

Set teacherlogin_cmd = Server.CreateObject ("ADODB.Command")
teacherlogin_cmd.ActiveConnection = MM_room_STRING
teacherlogin_cmd.CommandText = "SELECT * FROM dbo.Teacher" 
teacherlogin_cmd.Prepared = true

Set teacherlogin = teacherlogin_cmd.Execute
teacherlogin_numRows = 0
%>
<%
...
If MM_valUsername <> "" Then
  ...
  MM_redirectLoginSuccess = "Tpage.asp"
  MM_redirectLoginFailed = "Tlogin.asp"

  MM_loginSQL = "SELECT Tno, Tpassword"
  If MM_fldUserAuthorization <> "" Then MM_loginSQL = MM_loginSQL & "," & MM_fldUserAuthorization
  MM_loginSQL = MM_loginSQL & " FROM dbo.Teacher WHERE Tno = ? AND Tpassword = ?"
...
function MM_validateForm() { //v4.0
  if (document.getElementById){
	...
	<table width="400" border="0" align="center">
    	<form action="<%=MM_LoginAction%>" method="POST" id="get">
 			<tr>

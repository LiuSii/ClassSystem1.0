...
If (CStr(Request("MM_insert")) = "form1") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "INSERT INTO dbo.Log (Ltime, Ldate, Lroom) VALUES (?, ?, ?)" 
    ...
    MM_editRedirectUrl = "MUClverify.asp"
    If (Request.QueryString <> "") Then
...
Recordset1_cmd.CommandText = "SELECT * FROM dbo.Classroom WHERE Clno = ?" 
...
<table width="200" border="1">
  <tr>
    <td><input name="no" type="text" value="<%=(Recordset1.Fields.Item("Clno").Value)%>" /></td>
    <td><input name="capa" type="text" value="<%=(Recordset1.Fields.Item("Clcapa").Value)%>" /></td>
    <td><input name="site" type="text" value="<%=(Recordset1.Fields.Item("Clsite").Value)%>" /></td>
  </tr>
</table>

...
If (CStr(Request("MM_insert")) = "get") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "INSERT INTO dbo.Manager (Mno, Mname, Mpassword, Miphone) VALUES (?, ?, ?, ?)" 
...
Set MaddMan_cmd = Server.CreateObject ("ADODB.Command")
MaddMan_cmd.ActiveConnection = MM_room_STRING
MaddMan_cmd.CommandText = "SELECT * FROM dbo.Manager" 
MaddMan_cmd.Prepared = true

Set MaddMan = MaddMan_cmd.Execute
MaddMan_numRows = 0
%>

...
If (CStr(Request("MM_insert")) = "get") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "INSERT INTO dbo.Classroom (Clno, Clcapa, Clsite) VALUES (?, ?, ?)" 
...
Set Maddcla_cmd = Server.CreateObject ("ADODB.Command")
Maddcla_cmd.ActiveConnection = MM_room_STRING
Maddcla_cmd.CommandText = "SELECT * FROM dbo.Classroom" 
Maddcla_cmd.Prepared = true

Set Maddcla = Maddcla_cmd.Execute
Maddcla_numRows = 0
%>

...
If (CStr(Request("MM_insert")) = "get") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "INSERT INTO dbo.Teacher (Tno, Tname, Tpassword, Tiphone) VALUES (?, ?, ?, ?)" 
...
Set MaddTea_cmd = Server.CreateObject ("ADODB.Command")
MaddTea_cmd.ActiveConnection = MM_room_STRING
MaddTea_cmd.CommandText = "SELECT * FROM dbo.Teacher" 
MaddTea_cmd.Prepared = true

Set MaddTea = MaddTea_cmd.Execute
MaddTea_numRows = 0
%>

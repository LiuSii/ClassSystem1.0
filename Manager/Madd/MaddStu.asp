...
Set MaddStu_cmd = Server.CreateObject ("ADODB.Command")
MaddStu_cmd.ActiveConnection = MM_room_STRING
MaddStu_cmd.CommandText = "SELECT * FROM dbo.Student" 
MaddStu_cmd.Prepared = true

Set MaddStu = MaddStu_cmd.Execute
MaddStu_numRows = 0
%>
